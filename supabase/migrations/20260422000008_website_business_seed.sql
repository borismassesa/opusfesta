-- Seed Business Showcase section with current hardcoded content from
-- apps/opus_website/src/components/business.tsx
...
(
  ...
  '{
    ...
    "subheadline": "Connect with couples actively planning their wedding. Manage bookings, communicate with clients, and grow your business. All in one place.",
    "feature_pills": [
