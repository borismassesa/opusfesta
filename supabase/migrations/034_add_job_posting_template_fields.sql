...
SET 
  ...
  how_to_apply = COALESCE(how_to_apply, 'If you''re excited about this opportunity and believe you''d be a great fit for OpusFesta, we''d love to hear from you. 👉 Apply by submitting your resume through our careers page.'),
  equal_opportunity_statement = COALESCE(equal_opportunity_statement, 'OpusFesta is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees.')
