...
const CONFETTI_COLORS = ['#FF8800', '#CC6500', '#FFE7CE', '#171717', '#FFB56B'];
          ...
          {formState === 'success' ? (
            <div className="relative flex-1 flex flex-col items-center justify-center text-center py-20">
              ...
              <div className="relative z-30 w-16 h-16 border-4 border-brand-accent flex items-center justify-center mb-8">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#FF8800" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
