...
export const ImageUploadNode = Node.create<ImageUploadNodeOptions>({
  ...
  addNodeView() {
    // React 19 component types are stricter than what TipTap's
    // ReactNodeViewRenderer expects in v3.22 — runtime behavior is fine.
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return ReactNodeViewRenderer(ImageUploadNodeComponent as any)
  },
