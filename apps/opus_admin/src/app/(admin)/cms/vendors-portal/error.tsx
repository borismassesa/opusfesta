...
// Vendors-portal CMS scoped error boundary. Same contract as the homepage
// CMS error boundary — keep the section sidebar visible while a single
// editor renders an actionable error message.

import { useEffect } from 'react'
import { AlertCircle, RotateCw } from 'lucide-react'

export default function VendorsPortalCmsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[opus_admin] vendors-portal CMS editor error:', error)
  }, [error])
