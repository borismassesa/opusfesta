...
// CMS-editor scoped error boundary. Keeps the homepage CMS shell (section
// sidebar + header action bar) visible when a single section editor throws,
// so admins can still navigate to other sections rather than being stuck on
// Next.js's blank "client-side exception" page.

import { useEffect } from 'react'
import { AlertCircle, RotateCw } from 'lucide-react'

export default function HomepageCmsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[opus_admin] homepage CMS editor error:', error)
  }, [error])
