...
export const PERMISSIONS: Permission[] = [
  ...
  { key: 'opuspass.couples.write', group: 'OpusPass', label: 'Manage couple accounts', description: 'Link unattributed orders, adjust send credits and add internal account notes.' },
