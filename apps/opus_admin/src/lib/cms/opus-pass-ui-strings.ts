  ...
  'dashboard-thank-you': [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'card_unlock_cta', label: 'Unlock button', kind: 'text', max: 40, hint: 'Use {fee}' },
        { key: 'card_unlock_message', label: 'WhatsApp unlock request message', kind: 'text', max: 200, hint: 'Use {couple} and {fee}' },
      ],
    },
    {
      legend: 'Guest table',
