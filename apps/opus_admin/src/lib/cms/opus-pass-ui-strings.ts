...
export const UI_STRINGS_SCHEMA: Record<UiArea, CopyFieldGroup[]> = {
  ...
  'dashboard-events': [
    ...
    },
    {
      ...
      fields: [
        { key: 'section_meal_preferences', label: 'Section title', kind: 'text', max: 40 },
        { key: 'toggle_collect_meal', label: 'Toggle: collect meal', kind: 'text', max: 80 },
        { key: 'aria_remove_meal', label: 'Remove meal aria-label ({option})', kind: 'text', max: 40 },
        { key: 'placeholder_meal_option', label: 'Meal option placeholder', kind: 'text', max: 60 },
        { key: 'add_meal_option', label: 'Add meal option button', kind: 'text', max: 40 },
      ],
    },
    {
  ...
  'dashboard-send': [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'quota_topup', label: 'Top up link', kind: 'text', max: 20 },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'send_via_whatsapp', label: 'Send via WhatsApp chip', kind: 'text', max: 30 },
