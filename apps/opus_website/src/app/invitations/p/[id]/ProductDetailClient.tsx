...
const PAPER_QTY_OPTIONS = [50, 100, 150, 200, 300, 500]
          ...
          <div className="space-y-7">
            ...
            <div className="bg-[#F5EFE3]/60 border border-[#E8D9A7]/50 rounded-md p-5">
              ...
              <ul className="space-y-1.5 text-[13px] text-gray-700">
                {[
                  ...
                  'Unique QR barcode on every invite — for fast door-scan check-in',
                  'Guests without smartphones receive a unique SMS code as a fallback',
                  'Automated reminder texts before the event — no chasing required',
            ...
            <div className="border-t border-gray-200">
              <Accordion title="Details" defaultOpen>
                ...
                <p className="mt-3">
                  Every invite carries a unique QR barcode for fast scan-in at the door. Guests without
                  smartphones still get their own unique code by SMS — so no one is left out. Automated
                  reminder texts go out before the event, so you never have to chase an RSVP again.
                </p>
                <dl className="grid grid-cols-[110px_1fr] gap-y-1 mt-3 text-[13px]">
                  ...
                  <dt className="font-bold">Check-in</dt><dd>Unique QR barcode on every invite</dd>
                  <dt className="font-bold">No smartphone</dt><dd>Unique SMS code as fallback</dd>
                  <dt className="font-bold">Reminders</dt><dd>Automated SMS before the event</dd>
                  {paperPrints && (
                    <>
