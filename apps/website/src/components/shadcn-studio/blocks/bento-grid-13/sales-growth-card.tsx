...
const SalesGrowthCard = () => {
  return (
    <Card className='h-full justify-between gap-11 rounded-3xl border border-border/70 bg-background/65 shadow-[0_24px_60px_-44px_rgba(15,23,42,0.4)]'>
      <div className='flex flex-col gap-8'>
        ...
        >
          ...
          <MotionPreset fade slide={{ direction: 'down', offset: 35 }} delay={1.05} transition={{ duration: 0.5 }}>
            <ChartContainer config={totalEarningChartConfig} className='h-48 w-full'>
