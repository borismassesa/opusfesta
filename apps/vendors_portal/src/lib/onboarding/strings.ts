...
const DICT = {
  ...
  'profile.location.house.label': { en: 'Building / Plot number', sw: 'Namba ya jengo / kiwanja' },
  'profile.location.house.placeholder': { en: 'e.g. Plot 24, Building 12B', sw: 'mf. Kiwanja 24, Jengo 12B' },
  'profile.location.street.label': { en: 'Street / Village', sw: 'Mtaa / Kijiji' },
  'profile.location.street.placeholder': { en: 'e.g. Mwenge', sw: 'mf. Mtaa wa Mwenge' },
  'profile.location.ward.label': { en: 'Ward', sw: 'Kata' },
  'profile.location.ward.placeholder': { en: 'e.g. Kinondoni', sw: 'mf. Kinondoni' },
  'profile.location.district.label': { en: 'District', sw: 'Wilaya' },
  'profile.location.district.placeholder': { en: 'e.g. Kinondoni', sw: 'mf. Kinondoni' },
  'profile.location.region.label': { en: 'Region', sw: 'Mkoa' },
  'profile.location.region.placeholder': { en: 'Select region', sw: 'Chagua mkoa' },
  'profile.location.landmark.label': { en: 'Landmark / directions (optional)', sw: 'Alama ya kujulikana (hiari)' },
  'profile.location.landmark.placeholder': { en: 'e.g. Near Mlimani City, opposite the mosque', sw: 'mf. Karibu na Mlimani City, mkabala na msikiti' },
  'profile.location.postal.label': { en: 'P.O. Box / Postal code (optional)', sw: 'S.L.P / Msimbo wa posta (hiari)' },
  'profile.location.postal.placeholder': { en: 'e.g. P.O. Box 1234 or 11101', sw: 'mf. S.L.P 1234 au 11101' },
  ...
  'details.about.description.label': { en: 'Short description', sw: 'Maelezo mafupi' },
  ...
  'details.about.description.hint': { en: '{n}/200 characters.', sw: 'Herufi {n}/200.' },
  ...
  'details.services.custom.heading': { en: 'Other services', sw: 'Huduma nyingine' },
  'details.services.custom.hint': { en: "Add anything specific to your business that isn't in the list above.", sw: 'Ongeza chochote mahususi kwa biashara yako ambacho hakipo kwenye orodha hapo juu.' },
  'details.services.custom.label': { en: 'Add another service', sw: 'Ongeza huduma nyingine' },
  'details.services.custom.placeholder': { en: 'e.g. Bridal henna sessions', sw: 'mf. Huduma ya hina ya bibi harusi' },
  'details.services.custom.add': { en: 'Add', sw: 'Ongeza' },
  'details.services.custom.remove': { en: 'Remove', sw: 'Ondoa' },
  ...
  'review.row.bio': { en: 'About your business', sw: 'Kuhusu biashara yako' },
