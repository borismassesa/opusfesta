...
// Admin sign-in (form left on white, dark feature panel right). The Clerk
// <SignIn>/<SignUp> component is passed as `children`; its card chrome is
// stripped via appearance overrides on the pages so it sits flush on the left.
