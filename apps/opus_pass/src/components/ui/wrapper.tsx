    ...
    () =>
      React.isValidElement(children)
        ? isAlreadyMotion
          ...
          : motion.create(children.type as string | React.ComponentType<unknown>)
        : null,
    [isAlreadyMotion, children]
  ) as React.ForwardRefExoticComponent<React.PropsWithoutRef<AnyProps> & React.RefAttributes<T>> | null
