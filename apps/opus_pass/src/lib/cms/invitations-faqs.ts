...
export const INVITATIONS_FAQS_FALLBACK: InvitationsFaqsContent = {
  ...
  items: [
    ...
    { id: 'payment', question: 'What payment methods do you accept?', answer: 'M-Pesa, Airtel Money, Tigo Pesa, and major bank cards. You can pay in full or split into two instalments, with the second due before any paper goes to print.' },
