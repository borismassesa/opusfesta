    ...
    try {
      ...
      if (data.accessToken && data.refreshToken) {
        ...
        if (sessionError) {
          ...
          toast.error("Email verified. Please sign in to continue.");
          router.push("/login");
          return;
        }
        ...
        if (sessionData.session) {
          ...
          const redirectPath = next || "/"; // Default to dashboard
          ...
          setTimeout(() => {
            toast.success("Email verified successfully! Welcome to OpusFesta!");
