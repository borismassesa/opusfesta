            ...
            <td style="padding: 48px;">
              ...
              <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #f0f0f0;">
                <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #888888;">
                  <strong style="color: #52525b;">Security reminder:</strong> Never share this code with anyone. OpusFesta will never ask for your verification code via phone or email.
                </p>
              </div>
            </td>
          </tr>
