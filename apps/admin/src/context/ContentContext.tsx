...
export function ContentProvider({ children }: { children: ReactNode }) {
  ...
  const isAdminRoute = pathname?.startsWith("/content") || pathname?.startsWith("/");
  ...
  const mergeContent = useCallback((incoming?: Partial<ContentState> | null) => {
    ...
    return {
      ...
      cta: {
        ...INITIAL_CONTENT.cta,
        ...incoming.cta,
        backgroundImage: (incoming.cta?.backgroundImage && typeof incoming.cta.backgroundImage === 'string' && incoming.cta.backgroundImage.trim() !== "") 
